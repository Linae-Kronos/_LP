...
function LazyPig_ZGRoll(id)
	...
	if LPCONFIG.ZG then	
		...
		if LazyPig_Raid() and (string.find(name ,"Hakkari Bijou") or string.find(name ,"Coin") or string.find(name ,"Lava Core") or string.find(name ,"Fiery Core") or string.find(name ,"Blood of the Mountain") or string.find(name ,"Essence of Fire") or string.find(name ,"Essence of Earth") or string.find(name ,"Eternium Lockbox") or string.find(name ,"Girdle of Prophecy") or string.find(name ,"Vambraces of Prophecy") or string.find(name ,"Arcanist Belt") or string.find(name ,"Arcanist Bindings") or string.find(name ,"Felheart Belt") or string.find(name ,"Felheart Bracers") or string.find(name ,"Nightslayer Belt") or string.find(name ,"Nightslayer Bracelets") or string.find(name ,"Cenarion Belt") or string.find(name ,"Cenarion Bracers") or string.find(name ,"Giantstalker's Belt") or string.find(name ,"Giantstalker's Bracers") or string.find(name ,"Earthfury Bracers") or string.find(name ,"Earthfury Belt") or string.find(name ,"Belt of Might") or string.find(name ,"Bracers of Might") or string.find(name ,"Lawbringer Belt") or string.find(name ,"Lawbringer Bracers") or string.find(name ,"Aquamarine") or string.find(name ,"Star Ruby")) then
