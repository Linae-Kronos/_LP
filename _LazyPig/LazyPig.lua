...
function LazyPig_ZGRoll(id)
	...
	if LPCONFIG.ZG then	
		...
		if LazyPig_Raid() and (string.find(name ,"Hakkari Bijou") or string.find(name ,"Coin") or string.find(name ,"Lava Core") or string.find(name ,"Fiery Core") or string.find(name ,"Blood of the Mountain") or string.find(name ,"Essence of Fire") or string.find(name ,"Essence of Earth")) then
